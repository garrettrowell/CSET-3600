...
public class Graphics {
	...
	public static void draw(Pane canvas, ContextMenu contextMenu) {
		...
		for (Map.Entry<String, HUB> hubEntry : application.Data.hubMap.entrySet()) {
			...
			drawLine(canvas, Data.vlanstartPosX + 100, currentHub.getPosY() + 50, currentHub.getPosX(),
	...
	private static void vmNodeHidingListener(PopOver popover, VM vmObject, Pane canvas, ContextMenu contextMenu) {
		try {
			...
			if (!toggleBtn.isSelected()) {
				...
				// Object name
				LinkedHashMap<String, VM> updatedMap = Data.replaceVMKey(Data.vmMap, oldVM.getName(),
						newVmObject.getName());
